...
all_probs = []
all_filenames = []
for images, texts, filenames in get_data(batch_size = 10, image_src = img_src, text_data = file_label_dict):
...
print("top_label_text: \n", top_label_text)
savefilename = f"../resultcsv/{os.path.basename(files_src[:-4])}_results_test.csv"
